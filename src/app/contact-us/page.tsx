          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">Visit our <a href="#" className="text-primary hover:underline">Help Center</a></p>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">partnerships@scruvia.com</p>
                <p className="text-sm text-gray-500 mt-2">For partnership and business development inquiries.</p>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          {isSubmitted ? (
            <div className="bg-green-50 text-green-800 p-6 rounded-lg">
              ...
              <p className="mt-2">Thank you for contacting us. We will get back to you as soon as possible.</p>
              <button 
